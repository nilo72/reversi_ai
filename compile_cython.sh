...
cython3 -3 agents/q_learning_agent.pyx -o agents/q_learning_agent.c;
...
gcc -shared -I/usr/include/python3.4m -fPIC -pthread -fwrapv -O3 -Wall -fno-strict-aliasing agents/q_learning_agent.c -o agents/q_learning_agent.so; 
